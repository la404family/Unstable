# Textes de la mission et leurs emplacements

Ce fichier répertorie tous les textes traduisibles (`STR_...`) trouvés dans le code et leur valeur correspondante (issue de `stringtable.xml`).
...
| `STR_LL_Heli_Msg_Landed_Reinforce` | [SUPPORT] Hélicoptère posé. Débarquement des renforts. |
